...
const PROJECTS = [
    {
        ...
        techStack: ['React', 'PostgreSQL', 'Express', 'Node.js', 'AWS Storage', 'JWT', 'JavaScript', 'Redis', 'Socket.io', 'Docker', 'Typescript'],
        description: "A full-stack chat application where users can send real-time messages to individuals or a group of people within a created chatroom. The goal of this project is to apply knowledge of websockets for instant communication and notifications. Caching will also be implemented for faster message load times. Cloud file storage will be included so users will be able to send different types of media mostly aimed at images. ",
